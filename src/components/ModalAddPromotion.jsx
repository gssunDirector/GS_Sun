...
export const ModalAddPromotion = ({ isOpen, closeModal, update, data, openModal }) => {
  ...
  const [editorData, setEditorData] = useState(formData.text);
  ...
  return (
    <>
      <Modal
        ...
        className="fixed left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-[#FAFAFA] w-[688px] overflow-y-auto h-[80vh] rounded-lg shadow-md p-8 "
      ...
      >
        ...
        <form onSubmit={(e) => handleSave(e)} className="pt-6 flex flex-col gap-[20px] mb-[20px]">
          ...
          <label className="flex flex-col gap-[8px]">
            ...
            <div>
              ...
              <Editor value={editorData || formData.text} onChange={handleEditorChange} />
            </div>
          </label>
          ...
          <div className="flex flex-row justify-between">
            ...
            <div className="flex justify-end">
              <BigButton type="submit" label={"Попередній перегляд"} labelColor="white" />
            </div>
          </div>
        </form>
      </Modal>
